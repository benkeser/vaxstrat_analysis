  ...
  for(i in 1:nrow(grid)){
    ...
    result_df <- data.frame(
      ...
      estimand = c(rep("nat_inf",7),
                   rep("doomed",3),
                   rep("pop",3)),
      method = c(c("gcomp", "ipw", "aipw_CW", "tmle"),
                 c("gcomp_ER", "ipw_ER", "aipw_ER", "aipw_CW_ER"),
                 c("gcomp", "ipw", "aipw"),
                 c("gcomp", "ipw", "aipw")),
      ...
      additive_estimate = c(
        ...
        c(res$nat_inf$gcomp_ER$pt_est['additive_effect'],
          ...
          res$nat_inf$aipw_CW_ER$pt_est['additive_effect']),
      ...
      additive_lower_ci = c(
        ...
        c(res$nat_inf$gcomp_ER$boot_se$lower_ci_additive,
          ...
          res$nat_inf$aipw_CW_ER$pt_est['additive_effect'] - 1.96*res$nat_inf$aipw_CW_ER$pt_est['additive_se']),
      ...
      mult_estimate = c(
        c(exp(as.numeric(res$nat_inf$gcomp$pt_est['log_multiplicative_effect'])),
          ...
          exp(as.numeric(res$nat_inf$aipw_CW$pt_est['log_multiplicative_effect'])),
        ...
        c(exp(as.numeric(res$nat_inf$gcomp_ER$pt_est['log_multiplicative_effect'])),
          ...
          exp(as.numeric(res$nat_inf$aipw_CW_ER$pt_est['log_multiplicative_effect']))),
      ...
      mult_lower_ci = c(
        ...
        c(res$nat_inf$gcomp_ER$boot_se$lower_ci_mult,
          ...
          exp(res$nat_inf$aipw_CW_ER$pt_est['log_multiplicative_effect'] - 1.96*res$nat_inf$aipw_CW_ER$pt_est['log_multiplicative_se'])),
      ...
      psi_1 = c(
        ...
        c(res$nat_inf$gcomp_ER$pt_est['psi_1'],
          ...
          res$nat_inf$aipw_CW_ER$pt_est['psi_1']),
      ...
      psi_1_lower_ci = c(
        ...
        c(res$nat_inf$gcomp_ER$boot_se$lower_ci_psi_1,
          ...
          res$nat_inf$aipw_CW_ER$pt_est['psi_1'] - 1.96*res$nat_inf$aipw_CW_ER$pt_est['se_psi_1']),
        c(res$doomed$gcomp$boot_se$lower_ci_additive,
          res$doomed$ipw$boot_se$lower_ci_additive,
      ...
      psi_0 = c(
        ...
        c(res$nat_inf$gcomp_ER$pt_est['psi_0'],
          ...
          res$nat_inf$aipw_CW_ER$pt_est['psi_0']),
      ...
      psi_0_lower_ci = c(
        ...
        c(res$nat_inf$gcomp_ER$boot_se$lower_ci_psi_0,
          ...
          res$nat_inf$aipw_CW_ER$pt_est['psi_0'] - 1.96*res$nat_inf$aipw_CW_ER$pt_est['se_psi_0']),
        c(res$doomed$gcomp$boot_se$lower_ci_additive,
          res$doomed$ipw$boot_se$lower_ci_additive,
...
saveRDS(summary_df, paste0("results/generic_ER/", setting, "_summary.Rds"))
